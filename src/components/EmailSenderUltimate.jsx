            ...
            <div style={s.card}>
              <div style={{ background: 'rgba(251,191,36,0.1)', borderRadius: 12, padding: 20, border: '2px solid ' + theme.warning + '40', marginBottom: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: messageRotation ? 16 : 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}><Shuffle size={24} color={theme.warning}/><div><h3 style={{ margin: 0, color: theme.warning, fontSize: 16 }}>Message Rotation</h3><p style={{ margin: 0, fontSize: 12, color: theme.textMuted }}>Rotate templates</p></div></div>
